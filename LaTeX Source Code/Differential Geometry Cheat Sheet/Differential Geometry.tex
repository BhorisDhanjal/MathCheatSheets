...
\begin{center}{\fontsize{35}{60}{\textcolor{JungleGreen}{\textbf{Differential Geometry Cheat Sheet}}}}\\
\end{center}

\tikzset{every loop/.style={min distance=5mm,in=20,out=90,looseness=1}}
\tikzstyle{mybox} = [draw=JungleGreen, fill=white, very thick,
rectangle, rounded corners, inner sep=10pt, inner ysep=10pt]
\tikzstyle{fancytitle} =[fill=JungleGreen, text=white, font=\bfseries]
